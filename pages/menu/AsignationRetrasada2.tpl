...
<head>
    ...
    <script type="text/javascript">
        ...
        function generarOrden(codigoCurso){
            document.location.href = "saveAsignationRetrasada2.php?codigo="+codigoCurso;
            isStepValid = false;
        ...
        function eliminarOrden(codigoOrden){
            $.messager.confirm('CONFIRMAR',"Esta acción eliminirá y dejará sin validez la orden de pago No.: "+ codigoOrden+" \n ¿Continuar?", function(r){
                if (r){
                    document.location.href = "deleteAsignationR2.php?noOrden="+codigoOrden;
                    isStepValid = false;
                }
            });
        }
        function imprimirOrden(codigoOrden){
            document.location.href = "printAsignationR2.php?noOrden="+codigoOrden;
            isStepValid = false;
                            ...
                            <td valign="top" colspan="2">
                                <div id="treepane" tabindex="100">
                                    ...
                                    <div id="ffframe-large">
                                        <div id="ffheader">
                                            <span id="pff_title" class="page_title">Asignación de Segunda Retrasada</span>
                                            <div id="fffonticon">
                                        ...
                                        <div id="ffbody">
                                            <div id="page_content" class="page_content">
                                                ...
                                                <div id="ff_content">
                                                    ...
                                                    <div title='Asignacion de segunda retrasada' style='padding:10px'>
                                                                                    ...
                                                                                    <tr id="{aCurso}">
                                                                                        ...
                                                                                        <th style="padding-top: 5px; padding-bottom: 5px;"width="5%" align="left">
                                                                                            <div style='height:inherit;width: auto;' id='divIconoImprimir{aCurso}'>
                                                                                                <a class='btnImprimirOrden' href='#' onclick="javascript:imprimirOrden('{aOrden}');" title='Clic para imprimir la orden de pago del curso'>
