...
foreach($catalogoAprobados as $curso) {
 ...
 //   echo "num>>> ".$numcurso;//;die;
  ...
  //  }
    ...
    if ( ($curso['cod']!==620 && $curso['cod']!==621 && $curso['cod']!==622 && $curso['cod']!==623 && $curso['cod']!==600 && $curso['cod']!==605 && $curso['cod']!==615) && ($curso['fechaa'] != '12-1969' && $curso['fechaa'] != '01-1900') ){
    ...
    }elseif( ($curso['cod']==625 || $curso['cod']==606 || $curso['cod']==634 || $curso['cod']==600 || $curso['cod']==605 || $curso['cod']==615) &&( $curso['fechaa'] == '12-1969'  || $curso['fechaa'] == '01-1900') ){
        $pdf->SetY($pdf->Y);
        $pdf->SetFont('Arial','B',9);
