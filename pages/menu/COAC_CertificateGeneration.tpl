                            ...
                            <td valign="top" colspan="2">
                                ...
                                <div id="treepane" tabindex="100">
                                    ...
                                    <div class="demo tree tree-default" id="thetree" tabindex="100">
                                        <div id="ffframe">
                                            <div id="ffheader">
                                                <span class="page_title">Generacion de Certificado de Cursos</span>
                                                <div id="fffonticon">
                                                    <i class="fa fa-sun-o fa-spin fa-lg"></i>
                                                </div>
                                            </div>
                                            <div id="ffbody">
                                                <form name="busqueda" method="post" action="{aPost}"  target="_blank">
                                                    <div id="page_content" class="page_content">
                                                        <div class="ffpad fftop">
                                                            <div class="clear"></div>
                                                            <div id="headerrow2">
                                                                Especifique el Registro Academico del estudiante:
                                                             </div>
                                                        </div>
                                                        <br>
                                                        <div id="ff_content">
                                                            <div class="ff_pane" style="display: block;">
                                                                <table cellspacing="0" class="fffields">
                                                                    ...
                                                                    <tr>
                                                                        <td class="page_col1">
                                                                            <span class="formfilltranslation"><span id="_docwrite_formfill14">Registro Academico:</span></span>
                                                                        </td>
                                                                        <td class="page_col2">
                                                    ...
                                                    <div id="buttons">
                                                        <input id="Buscar" name="Buscar" type="submit" class="nbtn rbtn btn_midi btn_exp_h okbutton" value="Generar Certificado" >
                                                    </div>
                                                    <div class="clear">
                                                    </div>
                                                </form>
