                                ...
                                <div id="treepane" tabindex="100">
                                    ...
                                    <div class="demo tree tree-default" id="thetree" tabindex="100">
                                        <div id="ffframe">
                                            ...
                                            <div id="ffbody">
                                                <form name="busqueda" method="post" action="{aPost}" onsubmit="bloquearymostrar(document.busqueda.Buscar);">
                                                    <div id="page_content" class="page_content">
                                                        <div class="ffpad fftop">
                                                            <div class="clear"></div>
                                                            <div id="headerrow2">
                                                                Especifique el año y período para la carga de notas
                                                            </div>
                                                        </div>
                                                        <br>
                                                        <div id="ff_content">
                                                            <div class="ff_pane" style="display: block;">
                                                                <table cellspacing="0" class="fffields">
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2" align="center">
                                                                            <div id="barra" class="Estilo1" style="display:none">
                                                                                <img name='imgBarra' src='../../resources/images/espera.gif' width='375'
                                                                                     height='14'><br>
                                                                                <label>Espere mientras se procesa la información ...</label>
                                                                            </div>

                                                                            <div id="barraProceso"
                                                                                 style="font-family:Arial, Helvetica, sans-serif; color:#003366; display:none">
                                                                                <br><br>
                                                                                <img name="espera" src="../../resources/images/espera.gif" width="360"
                                                                                     heigth="12"><br>
                                                                    ...
                                                                    <tr>
                                                                        <td class="page_col1">
                                                                            <span class="formfilltranslation"><span id="_docwrite_formfill14">Periodo</span></span>
                                                                        </td>
                                                                        <td class="page_col2">
                                                                    ...
                                                                    <tr>
                                                                        <td class="page_col1">
                                                                            <span class="formfilltranslation">
                                                                                <span id="_docwrite_formfill28">Año</span>
                                                                            </span>
                                                                        </td>
                                                                        <td class="page_col2">
                                                    ...
                                                    <div id="buttons">
                                                        <input id="Buscar" name="Buscar" type="submit" class="nbtn rbtn btn_midi btn_exp_h okbutton" value="Buscar cursos impartidos">
                                                    </div>
                                                    <div class="clear">
                                                    </div>
                                                </form>
