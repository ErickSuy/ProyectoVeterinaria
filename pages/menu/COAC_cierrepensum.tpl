                            ...
                            <td valign="top" colspan="2">
                                ...
                                <div id="treepane" tabindex="100">
                                    ...
                                    <div class="demo tree tree-default" id="thetree" tabindex="100">
                                        <div id="ffframe">
                                            <div id="ffheader">
                                                <span class="page_title">Generacion de Cierre de Pensum</span>
                                                <div id="fffonticon">
                                            ...
                                            <div id="ffbody">
                                                <form name="busqueda" method="post" action="{aPost}"  target="_blank">
                                                    ...
                                                    <div id="buttons">
                                                        <input id="Buscar" name="Buscar" type="submit" class="nbtn rbtn btn_midi btn_exp_h okbutton" value="Generar Cierre" >
                                                    </div>
                                                    <div class="clear">
                                                    </div>
                                                </form>
