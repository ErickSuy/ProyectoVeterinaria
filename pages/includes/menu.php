...
if ($objuser->getGroup() == GRUPO_ESTUDIANTE) {
    ...
    if($objuser->getGroup()==GRUPO_DOCENTE) {
        ...
        if (isPrivilege("CERTIFICACION DE CURSOS", $privileges)) {
            ...
            if (isPrivilege("CIERRE DE PENSUM", $privileges)) {
                $vMenu = $vMenu .
                    '<div title="&nbsp;Cierre de Pensum" iconCls="fa fa-bars" style="overflow:auto;padding:10px;">
            <div id="main-menu-v">
                <ul class="main-menu">
                    <li>
                        <a href="../menu/COAC_cierrepensum.php">
                            <table>
                                <tr>
                                    <td><i class="fa fa-dot-circle-o"></i></td>
                                    <td><span>&nbsp;Cierre de Pensum</span></td>
                                </tr>
                            </table>
                        </a>
                    </li>
			...
			// añadido 2017-03-22
			if (isPrivilege("NIVEL DE IDIOMA", $privileges)) {
                $vMenu = $vMenu .
                    '<div title="&nbsp;Nivel de Idioma" iconCls="fa fa-sort-numeric-desc" style="overflow:auto;padding:10px;">
            <div id="main-menu-v">
                <ul class="main-menu">
                    <li>
                        <a href="../menu/COAC_nivelidioma.php">
                            <table>
                                <tr>
                                    <td><i class="fa fa-dot-circle-o"></i></td>
                                    <td><span>&nbsp;Registrar certificado</span></td>
                                </tr>
                            </table>
                        </a>
                    </li>
