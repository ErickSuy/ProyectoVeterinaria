...
$ns="http://parnaso.usac.edu.gt/WSGeneracionOrdenPago/WSGeneracionOrdenPagoSoapHttpPort";
$oSoap = new nusoap_client($ns.'?wdsl');
//$oSoap = new soapclient($ns,'wsdl');
/*
...
$cadena = "<GENERAR_ORDEN>
			 ...
			 <CARRERA>9</CARRERA>
			 <NOMBRE>Jose Rodolfo España de Leon--Prueba</NOMBRE>
			 <MONTO>303</MONTO>
			 <DETALLE_ORDEN_PAGO>
...
//print $cadena . ":::<br>";
//$cadena='';
print htmlspecialchars($cadena, ENT_QUOTES);
print ":::<br>";
//$dato = $oSoap->call('generarOrdenPago',array('symbol'=>$cadena),$ns);
$dato = $oSoap->call('generarOrdenPago',array('pxml'=>$cadena));
//$dato = $oSoap->call(array('parameters'=>$cadena),'generarOrdenPago');
//$dato = $oSoap->call($cadena,'generarOrdenPago');
 if ($oSoap->fault) {
...
$url = 'http://parnaso.usac.edu.gt/WSGeneracionOrdenPago/WSGeneracionOrdenPagoSoapHttpPort';
