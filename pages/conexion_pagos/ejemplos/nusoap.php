...
/home/boris/Documentos/EPS/Sistemas/portal2/portal2/conexion_pagos/ejemplos/nusoap.php : US-ASCII
-->
...
class soap_transport_http extends nusoap_base {
	...
	*/
	...
	function connect($timeout){
                ...
                $this->setError('[Dani 4] aqui da el error');
		...
		if($timeout > 0){
			...
			$fp = fsockopen($host, $port, $this->errno, 

$this->error_str,$timeout);
...
$this->error_str);
		...
		if(!$fp) {
			...
			$this->debug('Couldn\'t open socket 

connection to server '.$this->url.', Error: '.$this->error_str);

			$this->setError('[Dani 4] Couldn\'t open socket 
...
//                        $this->setError('[Dani 3] No hay conexion');
	...
	*/
	...
	function sendHTTPS($data, $timeout=30) {
...
class soap_server extends nusoap_base {
	...
	*/
	...
	function register($name,$in=false,$out=false,$namespace=false,$soapaction=false,$style=false,$use=false,$documentation='Missing documentation'){
    ...
    */
    ...
    function webDescription(){
		...
		<style type="text/css">
			...
			padding: 20px; font-size: 12px; background-color: #999999;
...
// Version modificada en base a:

// http://ghostwire.com/archives/phpobject/000019.html

//

// para poder consumir multiples servicios del mismo tipo de binding

// (especificamente SOAP).

//

// Este problema surgio al intentar consumir
...
class soapclient extends nusoap_base  {
	...
	*/
	...
	function soapclient($endpoint,$wsdl = false){
                ...
                $this->proxyhost = "proxy.uniovi.es";
	...
	*/
	...
	function send($msg, $soapaction = '', $timeout=30) {
