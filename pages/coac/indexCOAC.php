...
<head>
    ...
    <title>::Facultad de Medicina Veterinaria y Zootecnia - USAC/Admin. Académica</title>
    ...
    <div id="corte">
        ...
        <div class="content">
            ...
            <form class="form-vertical login-form" action="../../fw/view/User.php?service=3" method="post">
                <h3 class="form-title">CONTROL ACADÉMICO</h3>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-icon ">
                            <input type="hidden" value="4" name="group" id="group"/>
                            <?php
                            if (isset($_GET['fail'])) {
