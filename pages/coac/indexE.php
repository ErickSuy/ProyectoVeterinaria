...
<head>
    ...
    <title>::Facultad de Medicina Veterinaria y Zootecnia - USAC/Admin. Académica/ESTUDIANTE</title>
    ...
    <div id="corte">
        ...
        <div class="content">
            ...
            <form class="form-vertical login-form" action="../../fw/view/User.php?service=3" method="post">
                <h3 class="form-title">ESTUDIANTE</h3>
                ...
                <div class="control-group">
                    ...
                    <label class="control-label visible-ie8 visible-ie9">Carnet</label>

                    <div class="controls">
                        <div class="input-icon leftt">
                            <i class="icon-user"></i>
                            <input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Carnet"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-icon leftt">
                            <i class="icon-lock"></i>
                            <input class="m-wrap placeholder-no-fix" type="password" autocomplete="off" placeholder="Pin"
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="input-icon left">
                            <input type="hidden" value="3" name="group" id="group"/>
                            <select id="career" name="career" style="width:240px;" editable="false" panelheight="auto"
                                    required="true">
                                <option></option>
