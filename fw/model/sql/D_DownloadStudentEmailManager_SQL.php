...
Class D_DownloadStudentEmailManager_SQL extends General_SQL {
    ...
    function notasDeLaboratorio_select1_2(){
        return "(l.endyear > ad.year or (l.endschoolyear in ('101','200','201') and l.endyear=ad.year))";
    }
    ...
    function notasDeLaboratorio_select1($periodo,$anio,$curso,$seccion,$comparacionAdicional,$index){
        ...
        " and l.idcourse=ad.idcourse and ad.idschoolyear='" . $periodo . "' and ad.year='" . $anio . "' and (ad.idcourse=" . $curso . " and ad.index=".$index.")".
    ...
    function _select1($curso,$seccion,$periodo,$anio,$index){
         ...
         */
        return "select distinct e.idstudent,trim(e.name)||' '||trim(e.surname) as name,case when e.email='' or e.email is null then '' else e.email end as email" .
        " from tbstudent e, tbassignation a, tbassignationdetail ad" .
        " where a.idassignation=ad.idassignation" .
        " and  e.idstudent=a.idstudent and (ad.idcourse='" . $curso . "' and ad.index=" . $index.")".
    ...
    function _select2($periodoAnterior,$anio,$periodo,$curso,$seccion,$index){
        return "select a2.idstudent,trim(e.name)||' '||trim(e.surname) as anme,ad1.labnote,ad1.classzone,case when e.email='' or e.email is null then 'S/E' else e.email end as email" .
        ...
        " and ad1.idcourse=ad2.idcourse and ad1.section=ad2.section and ad1.idschoolyear='" . $periodoAnterior .
